...
local ToggleChest = Tabs.Main:AddToggle("ToggleChest", {
    ...
    Description = "Nháº·t RÆ°Æ¡ng dá»«ng Khi CÃ³ Váº­t Pháº©m [Tp]", 
    Default = false })
...
local ToggleChestTween = Tabs.Main:AddToggle("ToggleChestTween", {
    ...
    Description = "Nháº·t RÆ°Æ¡ng [Bay]", 
    Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = " Enable Bring Mob / Magnet",Description = "Gom QuÃ¡i", Default = true })
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Enable Bypass Tp",Description = "Di Chuyá»ƒn Dáº¡ng Reset", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = " Enable Remove Dame Text",Description = "áº¨n Dame ÄÃ¡nh QuÃ¡i", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = " Enable Remove All Notify",Description = "áº¨n háº¿t ThÃ´ng bÃ¡o", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = " Enable White Screen",Description = "MÃ n hÃ¬nh Treo", Default = false })
...
local ToggleBuy = Tabs.Fruit:AddToggle("ToggleBuy", {Title = "Buy Chip", Description = "Mua Chip + GiÃªÌt QuaÌi + Qua ÄaÌ‰o",Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Fruit:AddToggle("ToggleStart", {Title = "Start Raid",Description = "VÃ o Raid", Default = false })
...
local ToggleAwake = Tabs.Fruit:AddToggle("ToggleAwake", {Title = "Auto Awake",Description = "Thá»©c tá»‰nh V2", Default = false })
...
local ToggleGetFruit = Tabs.Fruit:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Bely",Description = "Láº¥y TrÃ¡i Ãt Bely", Default = false })
...
local ToggleLaw = Tabs.Fruit:AddToggle("ToggleLaw", {Title = "Auto Law",Description = "Tá»± mua chip + ÄÃ¡nh boss law", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Collect Devil Fruit",Description = "Nháº·t TrÃ¡i", Default = false })
...
local ToggleTweenGear = Tabs.Raid:AddToggle("ToggleTweenGear", {Title = "Tween To Gear",Description = "Nháº·t BÃ¡nh RÄƒng", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Raid:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill",Description = "NhÃ¬n TrÄƒng + Báº­t Tá»™c", Default = false })
    ...
    local ToggleSailBoat = Tabs.Raid:AddToggle("ToggleSailBoat", {Title = "Auto buy Boat",Description = "Mua Thuyá»n + Ngá»“i VÃ o", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Raid:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark",Description = "ÄÃ¡nh Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Raid:AddToggle("TogglePiranha", {Title = " Kill Piranha",Description = "ÄÃ¡nh Piranha", Default = false })
     ...
     local ToggleShark = Tabs.Raid:AddToggle("ToggleShark", {Title = " Kill Shark",Description = "ÄÃ¡nh CÃ¡", Default = false })
    ...
    local ToggleFishCrew = Tabs.Raid:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew",Description = "ÄÃ¡nh Fish Crew", Default = false })
    ...
    local ToggleShip = Tabs.Raid:AddToggle("ToggleShip", {Title = "Kill Ship",Description = "ÄÃ¡nh Thuyá»n Háº£i Táº·c", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Raid:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship",Description = "ÄÃ¡nh Thuyá»n Ma",Default = false })
...
spawn(function()
 ...
 local Speed = Tabs.Raid:AddToggle("Speed", {Title = "Speed Boat",Description = "TÄƒng TÃ´Ìc ThuyÃªÌ€n",Default = false })
...
function NoFog()
    ...
    for r, v in pairs(c:GetDescendants()) do
      ...
      local RoughSea = Tabs.Raid:AddSection("ðŸ¦Š Kitsune ðŸ¦Š")
      ...
      local ToggleTPKitsune = Tabs.Raid:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island",Description = "Di Chuyá»ƒn Äáº¿n Äáº£o Kisune", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Raid:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers",Description = "Nháº·t Há»“n Lá»­a", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Random Bone",Description = "Äá»•i xÆ°Æ¡ng", Default = false })
